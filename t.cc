...
int RUN_ALL_TESTS() {
    ...
    for (int i = 0; i < func_cnt; i++) {
        printf("\033[0;1;" "32" "m" "[  RUN    ]" "\033[0m" " %s\n", func_arr[i].func_name);
        func_arr[i].func();
    }
    return 0;
}
...
void my_test_add1(); __attribute__((constructor)) void reg_test_add1() { add_test_func(my_test_add1, "test" "." "add1"); } void my_test_add1() {
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) == (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 19); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "==", "7", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (9); if (!((__a) != (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 20); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "!=", "9", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (8); if (!((__a) < (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 21); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "<", "8", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) <= (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 22); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "<=", "7", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (6); if (!((__a) > (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 23); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", ">", "6", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) >= (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 24); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", ">=", "7", __a, __b); } };
}

void my_test_add2(); __attribute__((constructor)) void reg_test_add2() { add_test_func(my_test_add2, "test" "." "add2"); } void my_test_add2() {
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) == (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 28); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "==", "7", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (9); if (!((__a) != (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 29); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "!=", "9", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (8); if (!((__a) < (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 30); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "<", "8", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) <= (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 31); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", "<=", "7", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (9); if (!((__a) > (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 32); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", ">", "9", __a, __b); } };
    { __typeof(add(3, 4)) __a = (add(3, 4)), __b = (7); if (!((__a) >= (__b))) { printf("\033[0;1;" "33" "m" "  %s:%d: Failure\n" "\033[0m", "mytest.cc", 33); printf("\033[0;1;" "33" "m" "    Expected: (%s) %s (%s), actual: %d vs %d\n" "\033[0m", "add(3, 4)", ">=", "7", __a, __b); } };
}
